        ...
        <footer
            ...
            <div
                ...
                <div className="flex justify-center">
                    ...
                    <Link
                        href="https://www.instagram.com/breezstraw.vn/profilecard/?igsh=NG5wOGQyNDZoN3No"
                        className="mr-6 text-neutral-600 dark:text-neutral-200"
                        target="_blank" // Mở trong tab mới
                        rel="noopener noreferrer" // Tăng cường bảo mật khi dùng target="_blank"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4"
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <p>
                            <Link href="/about" className="text-neutral-600 hover:text-blue-500 transition-all duration-300">
                                About
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <p className="flex items-center justify-center md:justify-start text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                                <path fillRule="evenodd" d="M1.5 4.5C1.5 3.119 2.619 2 4 2h16c1.381 0 2.5 1.119 2.5 2.5v13c0 1.381-1.119 2.5-2.5 2.5H4c-1.381 0-2.5-1.119-2.5-2.5v-13zM4 4c-.552 0-1 .448-1 1v1.4l9 5.4 9-5.4V5c0-.552-.448-1-1-1H4zm18 3.6l-9 5.4-9-5.4v9.9c0 .552.448 1 1 1h16c.552 0 1-.448 1-1V7.6z" clipRule="evenodd" />
                            </svg>
