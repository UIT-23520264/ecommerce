    ...
    return (
        <li className="flex py-6">
            <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                <Image
                    src={item.product.images[0]} // Dynamic image source
                    alt={item.product.name} // Dynamic alt text
                    width={96} // Set the width in pixels (optional)
                    height={96} // Set the height in pixels (optional)
